          ...
          <div className="flex-container">
            <div className="peeps">
              ...
              <p className="fancyShit">
                Brandon is a real gee no cap, goat brimstone player. Currently
                has big boi gpa and interning as Project Control Engineer at
                Desjardins
              </p>
            </div>
            <div className="peeps">
              ...
              <h6 className="role">McGill CS and Stats</h6>
              <p>
                Johan "Joho the Goat" Song is a high elo tft player. When he
                feels like gracing us with his presence, he is a "Python or
                bust" typa developer. He is Currently interning at Dash Plotly!
              </p>
            </div>
            <div className="peeps">
